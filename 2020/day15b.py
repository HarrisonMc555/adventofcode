...
def main():
    # unittest.main()
    print(MemoryGame.nth(STARTING_NUMS, 30000000))
...
class MemoryGame:
    ...
    def step(self):
        # if self.turn % 10_000 == 0:
        #     print(f'Turn {self.turn}, len(nums) = {len(self.num_to_turn)}')
...
class MemoryTests(unittest.TestCase):
    ...
    def test_30000000_example1(self):
        starting_nums = [0, 3, 6]
        self.assertEqual(175594, MemoryGame.nth(starting_nums, 30000000))

    # def test_30000000(self):
    #     test_cases = [
    #         ([0, 3, 6], 175594),
    #         ([1, 3, 2], 2578),
    #         ([2, 1, 3], 3544142),
    ...
    #         ([3, 1, 2], 362),
    #     ]
    #     for starting_nums, n_30000000 in test_cases:
    #         self.assertEqual(n_30000000, MemoryGame.nth(starting_nums, 30000000))
